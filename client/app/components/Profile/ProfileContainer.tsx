...
class ProfileContainer extends React.Component<ProfileProps, ProfileState> {
  ...
  render() {
    ...
    const viewProfile = (<div style={{textAlign: 'center'}}>
      ...
      <List component="nav">
        <ListItem>
          <ListItemText primary={`First name: ${this.props.userProfile.firstName}`} />
        </ListItem>
        <ListItem>
          <ListItemText primary={`Last name: ${this.props.userProfile.lastName}`} />
        </ListItem>
        <ListItem>
          <ListItemText primary={`Gender: ${this.props.userProfile.gender ? 'Female' : 'Male'}`} />
        </ListItem>
      </List>
      <Divider />
      <List component="nav">
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    loadTopics: () => {
      dispatch(ProfileActions.loadTopicStarted());
    }
  }
};
